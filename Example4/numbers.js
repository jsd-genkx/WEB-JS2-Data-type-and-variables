...
//---------------------------Fractions-------------------------------//
//Floating-point - the way JavaScript handles floating point numbers, you may sometimes get results that are very close to the expected result but not exactly equal.
let fraction = 3 / 4;
console.log(fraction); // Output: 0.75


//the decimal.js library can be used for arbitrary-precision decimal arithmetic in JavaScript.
// Create a Decimal instance for the numerator and denominator separately


// Representing 3/4 using decimal.js
const numerator = new Decimal(3);
const denominator = new Decimal(4);
const decimalFraction = numerator.div(denominator);

console.log(decimalFraction.toFraction()); // Output: 3/4
